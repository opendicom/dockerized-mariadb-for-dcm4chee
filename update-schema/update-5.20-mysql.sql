...
alter table export_task add batch_id varchar(255);
...
update export_task set batch_id = (select queue_msg.batch_id from queue_msg where queue_msg_fk = queue_msg.pk);
