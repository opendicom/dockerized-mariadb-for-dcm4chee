...
alter table retrieve_task add scheduled_time datetime;
alter table export_task modify scheduled_time datetime not null;
...
update retrieve_task
    set scheduled_time = (select queue_msg.scheduled_time from queue_msg
